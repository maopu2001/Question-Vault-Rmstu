...
export default function Loading(props) {
  return (
    <div
      {...props}
      className="fixed z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-screen h-screen bg-primary-500 opacity-70 flex items-center justify-center"
    >
